...
if(empty($krok))
{
	...
	echo "
			<form action='sz_aukro_pridat.php?krok=2' method='POST'>
...
elseif($krok == 2)
{
	...
	echo "
			<form action='sz_aukro_pridat.php?krok=3' method='POST'>
			<p>vs: ".$_POST["vs"]."
			<br>nick: ".$_POST["nick"]."
...
if($krok == 3)
{
	...
	if(!isset($_POST["act"]) or $_POST["act"] == "dalsi")
	{
		...
		echo "
			<form action='sz_aukro_pridat.php?krok=3&action=2' method='POST'>
			<p>vs: ".$_SESSION["vs"]."
