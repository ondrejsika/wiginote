...
//	$pdf->Text(110,60+$f,'Konecny prodej');
	...
	$pdf->Text(130,$c+5,"20");
	$pdf->Text(140,$c+5,round($wigishop->cena_celkem()*0.8,2));
	$pdf->Text(160,$c+5,round($wigishop->cena_celkem()*0.2,2));
	$pdf->Text(180,$c+5,$wigishop->cena_celkem());

	$pdf->SetFont('Arial','',14);
	$pdf->Text(130,$c+15,"Fakturace celkem");
	$pdf->Text(175,$c+15,round($wigishop->cena_celkem(),2)." Kc");
	$pdf->SetFont('Arial','',12);
...
if($xxx == 1)
{
	...
	header("location: download_fakt.php?vs=$vs"."_$i2e");
